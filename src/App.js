...
export default function App() {
  ...
  return (
    <div className={isOpen ? 'modal-open App' : 'App'}>
      <nav>
        <svg className="baseline" width="96" height="19" viewBox="0 0 96 19" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <button className="modal-button" onClick={() => setIsOpen(prev => !prev)}>
          <div className="border-right">
            {locationText}
          </div>
          <div className="border-right gray-text">
            {parseInt(guestCount.children) + parseInt(guestCount.adult) > 1 ? parseInt(guestCount.children) + parseInt(guestCount.adult) + ' Guests' : 'Add Guests'}
          </div>
          <div className="magnify-padding">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
              <path fill="#ec5f5f" d="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z" />
            </svg>
          </div>
        </button>
      </nav>
          ...
          <form>
            ...
            <div className="product-search">
              <div className="search-element">
                ...
                <input id="location" className="search-input gray-text" type="text" name="location" value={locationText} onChange={handleLocationChange} onFocus={() => setLocationToggle(prev => !prev)} />
                {locationToggle &&
              ...
              <div className="search-element">
                <button type="button" className="guests-button" onFocus={handleGuestToggle} onClick={handleGuestToggle}>
                  ...
                  <div className="guests-panel">
                    <div>
                      ...
                      <div className="flex align-center space-around">
                        <button type="button" name="adult-subtract" onClick={handleGuestCount} disabled={guestCount.adult === 0}>
                          -
                        </button>
                        {guestCount.adult}
                        <button type="button" name="adult-plus" onClick={handleGuestCount} disabled={guestCount.adult === 20}>
                          +
                        </button>
                      </div>
                    </div>
                    <div className="children-wrapper">
                      ...
                      <div className="flex align-center space-around">
                        <button type="button" name="children-subtract" onClick={handleGuestCount} disabled={guestCount.children === 0}>
                          -
                        </button>
                        {guestCount.children}
                        <button type="button" name="children-plus" onClick={handleGuestCount} disabled={guestCount.children === 20}>
                          +
                        </button>
                      </div>
                    </div>
      ...
      <main className={isOpen ? 'overlay-bg' : ''}>
        <Stays filteredStays={filteredStays} />
      </main>
    </div>
  );
}
